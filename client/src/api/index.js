...
//       data: { chat },
//     },
//   } = await httpClient.post("/chats", chatData);
...
// export async function createMessage({ chatId, body, userId }) {
//   const {
//     data: { data: message },
//   } = await httpClient.post(`/chats/${chatId}/messages`, { body, userId });
...
export const createMessage = async ({ chatId, text, authorId }) => {
  const {
    data: { data: message },
